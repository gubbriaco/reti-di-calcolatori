...
public class Azienda {
	...
	public static void main(String...strings) {
		...
		for(int i=0;i<N;++i) {
			...
			Azienda azienda = new Azienda(piva, address);
		
			final String host_name_server = "job.unical.it";
			final int TCP_PORT_INVIO = 3000,
					  TCP_PORT_CANDIDATURA = 5000;
			...
			try {
				...
				Offerta offerta = new Offerta("settore", "ruolo", "tipo", "ral", false, azienda.address);
